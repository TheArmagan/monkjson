...
function MonkJSON() {
     ...
     */
    this.setConnection = function setConnection(uri, collectionName = "monkjson") {
     ...
     * @throws "ERRCINO"
     */
    this.endConnection = function endConnection() {
     ...
     */
    this.DataBase = function DataBase(name) {
